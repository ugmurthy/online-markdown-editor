...
This is a little Markdown editor [Try here](https://ugmurthy.github.io/online-markdown-editor). It's designed to handle a bunch of cool stuff, making it easy to write and preview your documents.

This version also includes a resizable split view and editor visibility controls for a smoother writing workflow.

![Preview](asset/opening-screen.png)
...
While working with AI agents, I often need to review `.md` files they generate. VS Code requires a paid subscription for full markdown preview features, and its extensions don't fully render richer markdown elements like LaTeX math equations.

I found the [original editor by nav9v](https://github.com/nav9v/online-markdown-editor) and made several modifications to suit my workflow:

- **Draggable vertical separator** - Resize editor and preview panes
- **Hide/show editor** - Focus on rendered output when needed
- **Upload markdown files** - Quickly load local `.md` files for review
